...
export default class ItemComponente extends Component {
  ...
  render() {
    return(
        <View>
            <View style={{margin: 5}}>
            <Text style={estilo.titulo}>Investidor(id): {this.props.id}</Text>
            ...
            <TextInput style={estilo.entradaTexto}>Juros: R$ {Math.round(Juros*100)/100}         Retorno: R$ {Math.round(Retorno*100)/100} </TextInput>
